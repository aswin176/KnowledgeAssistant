...
SCHEMA_INDEXES = [
    ...
    "CREATE FULLTEXT INDEX entitySearch IF NOT EXISTS FOR (n:Person|Company|Skill|City|Event|University|Project|Technology|Certification) ON EACH [n.name, n.title, n.description, n.bio, n.industry, n.email]",
]

NODE_LABELS = [
    "Student", "Person", "Company", "Skill", "City", "Country", "Address",
...
RELATIONSHIP_TYPES = [
    "WORKS_AT", "WORKED_AT", "STUDIED_IN", "HAS_SKILL", "LIVES_IN", "LOCATED_IN",
    "HAS_PROFILE", "KNOWS", "ATTENDED", "HAS_DOCUMENT", "HAS_CERTIFICATION",
    "HAS_AWARD", "USES_TECHNOLOGY", "PARTICIPATED_IN", "MEMBER_OF", "FRIEND_OF",
    "CONNECTED_TO", "HAS_NOTE", "RELATED_TO",
]
